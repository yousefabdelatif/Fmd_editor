...
#from itx_compiler.tokens.Formats import Tokens, Elements
...
class TokenTree:
    ...
    def insert(self, elem:str):
        self.__currentToken.addChild(Tokens().resolve(elem=elem,parent=self.__currentToken))
